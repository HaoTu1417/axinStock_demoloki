                ...
                <div class="relative isolate z-20 min-h-screen pb-40">
                    <div class="space-y-4">
                        <div class="relative isolate bg-primary-500 py-3 text-center text-white" onclick="window.history.back();"><svg data-v-bd832875=""
                                ...
                                class="icon absolute left-4 top-1/2 isolate -translate-y-1/2 cursor-pointer" width="1em"
                        ...
                        <div class="px-4">
                            <form class="space-y-5">
                                <div class="text-sm"> Số dư hiện có: <span class="font-semibold"><?= number_format($information->money) ?></span></div>
                                <div class="flex flex-col text-sm"><label for="bank">Số điểm cần rút:</label><input
                                        id="bank" type="number" name="bank" min="0" max="0" placeholder="Số điểm cần rút"
                                        class="main-input remove-arrow mt-2 !py-2"><!----></div><!---->
                                <div class="flex justify-end"><button type="button" id="btnWithdrawal"
                                        class="relative rounded-xl border-2 border-white bg-gradient-to-l from-primary-300 to-primary-500 px-4 py-2 text-sm font-medium text-white focus:outline-0">
                                        Xác nhận </button></div>
                            </form>
                        </div>
                    </div>
                    <div class="fixed inset-x-0 bottom-0 z-30 flex items-center justify-center shadow-lg">
                        <div class="mx-auto size-full max-w-lg border-t bg-white text-gray-500">
                            ...
                            <div class="flex"><button onclick="window.location.href ='/';"
                                    ...
                                    </svg><span class="text-sm">Home</span></button><button
                                    onclick="window.location.href ='/feature?room=2';"
                                    class="flex w-full flex-col items-center justify-center py-2"><svg
                                        data-v-bd832875="" xmlns="http://www.w3.org/2000/svg"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img"
                                    ...
                                    </svg><span class="text-sm">Xu hướng</span></button><button
                                    ...
                                    class="flex w-full flex-col items-center justify-center py-2"><svg
                                        ...
                                        <ellipse cx="12" cy="17" fill="currentColor" rx="7"
                                            ry="4"></ellipse>
                                    </svg><span class="text-sm">Cá Nhân</span></button><button
